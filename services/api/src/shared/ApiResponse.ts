...
export const ResponseCode = {
  ...
  INTERNAL_ERROR: 1099,
  // 权限控制模块 14xx
  ACCESS_MENU_CODE_DUPLICATE: 1401,
  ACCESS_ACTION_CODE_DUPLICATE: 1402,
  ACCESS_ROLE_CODE_DUPLICATE: 1403,
  ACCESS_USER_DUPLICATE: 1404,
  ACCESS_TENANT_CODE_DUPLICATE: 1405,
  ACCESS_ROLE_IN_USE: 1406,
  ACCESS_DATA_SCOPE_INVALID: 1407,
  ACCESS_SYSTEM_OBJECT_PROTECTED: 1408,
  ACCESS_VERSION_CONFLICT: 1409,
  // SKU模块 2xxx
  SKU_NOT_FOUND: 2001,
  ...
  INV_WAREHOUSE_REQUIRED: 4005,
  INV_LOCATION_REQUIRED: 4006,
  INV_LOCATION_INVALID: 4007,
  // 采购模块 5xxx
  PO_NOT_FOUND: 5001,
