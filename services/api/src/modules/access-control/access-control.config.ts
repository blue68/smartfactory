...
const SYSTEM_MENU_DEFINITIONS: MenuSeedDefinition[] = [
  ...
  },
  {
    ...
    parentId: 9003001,
    menuType: 'page',
    code: 'consumables.issue',
    name: '损耗品领用',
    routePath: '/consumables/issues',
    icon: 'gift',
    groupName: '采购',
    sortOrder: 110,
    status: 'active',
  ...
  },
  {
    ...
    parentId: 9006001,
    menuType: 'page',
    code: 'assets.acceptance',
    name: '资产验收',
    routePath: '/assets/acceptance',
    icon: 'idcard',
    groupName: '仓库',
    sortOrder: 30,
    status: 'active',
...
const SYSTEM_ACTION_DEFINITIONS: ActionSeedDefinition[] = [
  ...
  { id: 9023703, tenantId: 0, menuId: 9003111, code: 'consumable:issue:view', name: '查看损耗品领用', actionType: 'view', status: 'active', defaultEnabled: true, roleCodes: ['boss', 'supervisor', 'purchaser', 'warehouse'] },
  { id: 9023704, tenantId: 0, menuId: 9003111, code: 'consumable:issue:create', name: '创建损耗品领用', actionType: 'create', status: 'active', defaultEnabled: true, roleCodes: ['boss', 'purchaser', 'warehouse'] },
  { id: 9023705, tenantId: 0, menuId: 9003111, code: 'consumable:issue:approve', name: '审批损耗品领用', actionType: 'approve', status: 'active', defaultEnabled: true, roleCodes: ['boss', 'supervisor'] },
  { id: 9023706, tenantId: 0, menuId: 9003111, code: 'consumable:issue:execute', name: '执行损耗品领用', actionType: 'custom', status: 'active', defaultEnabled: true, roleCodes: ['boss', 'warehouse'] },
  { id: 9023707, tenantId: 0, menuId: 9003111, code: 'consumable:stock:view', name: '查看损耗品库存', actionType: 'view', status: 'active', defaultEnabled: true, roleCodes: ['boss', 'supervisor', 'purchaser', 'warehouse'] },
  ...
  { id: 9024009, tenantId: 0, menuId: 9006103, code: 'asset:acceptance:create', name: '执行资产验收', actionType: 'create', status: 'active', defaultEnabled: true, roleCodes: ['boss', 'supervisor', 'warehouse'] },
  { id: 9024010, tenantId: 0, menuId: 9006104, code: 'asset:view', name: '查看资产台账', actionType: 'view', status: 'active', defaultEnabled: true, roleCodes: ['boss', 'supervisor', 'purchaser', 'warehouse'] },
  { id: 9024011, tenantId: 0, menuId: 9006104, code: 'asset:transfer', name: '资产调拨', actionType: 'custom', status: 'active', defaultEnabled: true, roleCodes: ['boss', 'supervisor', 'warehouse'] },
  { id: 9024012, tenantId: 0, menuId: 9006104, code: 'asset:return', name: '资产退回', actionType: 'custom', status: 'active', defaultEnabled: true, roleCodes: ['boss', 'supervisor', 'warehouse'] },
  { id: 9024013, tenantId: 0, menuId: 9006104, code: 'asset:scrap', name: '资产报废', actionType: 'approve', status: 'active', defaultEnabled: true, roleCodes: ['boss', 'supervisor'] },
